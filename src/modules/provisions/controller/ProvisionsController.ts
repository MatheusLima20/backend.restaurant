...
import { ProductTypeEntity } from "../../product.type/entities/ProductTypeEntity";
import { ProvisionsEntity } from "../entities/ProvisionsEntity";
...
export const ProvisionsController = {
    ...
    store: async (request: Request, response: Response) => {
        ...
        try {
            ...
            let unitMeasurement: UnitMeasurementEntity | null = null;
            let productType: ProductTypeEntity | null = null;
    ...
    patch: async (request: Request, response: Response) => {
        ...
        try {
            dataSource.transaction(async (transactionalEntityManager) => {
                ...
                const oldProduct: ProvisionsEntity | null =
                ...
                const product: any = {
                    ...
                    show: body.show,
                    toCook: body.toCook,
                    fkUnitMeasurement: unitMeasurement as any,
                    fkProductType: productType as any,
                    updatedBy: user.id,
                };
